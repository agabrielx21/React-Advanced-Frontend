  ...
  async function handleLogin(){
   try {
    ...
    console.log('Logged In.');
      ...
      setError('Failed to log in to your account, please make sure your email and password are correct.');
   }
  };
  ...
  async function handleGithubLogin(){
    ...
    try {
     ...
     console.log('Logged In.');
       ...
       setError('Failed to log in to your account, please try again.');
    }
   };
